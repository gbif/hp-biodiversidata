...
<style>
  ...
  .col-time   { width: 13%; }
  .col-act    { width: 50%; }
  .col-type   { width: 14%; text-align: center; }
  .col-charge { width: 23%; }
  td.col-type { text-align: center; }
  ul.act-list {
    margin: 4px 0 0 0;
    padding-left: 18px;
  }
  ul.act-list li { margin-bottom: 2px; }
  .dash-list {
    list-style: none;
    padding-left: 12px;
    margin: 4px 0 0 0;
...
<table class="schedule-table">
  <thead>
    <tr>
      <th class="col-time">Dia 1</th>
      <th class="col-act">Actividad</th>
      <th class="col-type">Tipo de<br>contenido</th>
      <th class="col-charge">A cargo de</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td>Ricardo Ortiz,<br>Clara Baringo,<br>Ricardo Segovia,<br>Eliana Walker<br></td>
    </tr>
    <tr class="lunch-row">
      <td colspan="4">PAUSA CAFÉ (5 min)</td>
    </tr>
    <tr>
      <td>10:30 - 11:30</td>
      <td>
    ...
    <tr class="lunch-row">
      <td colspan="4">ALMUERZO (1 hora)</td>
    </tr>
    <tr>
      <td>13:00 - 14:15</td>
    ...
    <tr>
      ...
      <td class="col-type">Práctico</td>
      <td>Clara Baringo,<br>Ricardo Ortiz,<br>Ricardo Segovia</td>
    </tr>
  </tbody>
</table>
...
<table class="schedule-table">
  ...
  <tbody>
    <tr>
      <td>09:30 - 10:45</td>
      <td>
        Herramientas de publicación - IPT<br>
        Ejercicio de llenado de Metadatos - IPT
      </td>
      <td class="col-type">Teórico - Práctico</td>
      <td>Ricardo Ortiz,<br>Clara Baringo</td>
    </tr>
      <tr class="lunch-row">
      <td colspan="4">PAUSA CAFÉ (5 min)</td>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          <li>Ventajas de usar métodos replicables</li>
        </ul>
      </td>
      <td class="col-type">Teórico - Práctico</td>
...
**Apoyan**: Departamento de Ecología y Gestión Ambiental (DEGA, CURE-UdelaR), Departamento de Modelización Estadística de Datos e Inteligencia Artificial (MEDIA, CURE-UdelaR) y Conservation Leadership Programme.